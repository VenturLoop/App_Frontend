    ...
    <SafeAreaView className=" h-screen flex-1 justify-between items-center w-full">
        ...
        >
          ...
          >
            ...
            <View className="px-4 bg-white  rounded-2xl">
              <View className="flex-row border-b-[1.5px] px-5  pb-3  w-full justify-between  border-gray-200">
                <View className="flex-row border-r-[1.5px] w-1/3 pt-4   border-gray-200 items-center">
                  {/* <FontAwesome name="cake-candles" size={18} color="gray" /> */}
                  <Image source={imagePath.cake} className="w-6 h-6" />
                  <Text className="ml-2  font-semibold text-gray-700">23</Text>
                </View>

                <View className="flex-row w-2/3 pt-4 justify-center items-center">
                  <Ionicons name="location-outline" size={18} color="vlack" />
            ...
            <View className="bg-white py-3 px-4 rounded-xl ">
              {/* Heading */}
              <Text className="text-lg font-bold mb-3">I’m interested in</Text>
            ...
            <View className="px-4 py-3 bg-white rounded-xl">
              {/* Heading */}
              <Text className="text-lg font-bold mb-3">My skills</Text>
            ...
            {/* My education */}
            <View className="gap-3 bg-white px-4 py-3 rounded-xl mt-5">
              ...
              <View className="flex flex-row border-b-[0.5px] py-4 border-gray-300">
                <Image className="w-16 h-16 border rounded-xl border-gray-200" source={imagePath.userImage} />
            ...
            {/* Experience */}
            <View className="p-4 bg-white py-3 pt-4 px-2 gap-4 rounded-xl">
              <Text className="text-gray-600  pl-3  font-semibold">
                My Experience
              </Text>
              {currentUser.experience.map((exp, index) => (
                <View
                  key={index}
                  className="border-y-[0.5px] px-3 border-gray-200 pt-4 pb-3"
                >
            ...
            <View className="bg-white rounded-xl py-4 px-4">
              <Text className="font-bold px-2 text-lg mb-2">My Projects</Text>
      ...
      <View className="absolute bottom-0 pb-3  shadow-  w-full items-center justify-between flex-row px-6 z-10">
        ...
        <TouchableOpacity
          ...
          className="p-3 bg-white rounded-full border-[0.5px] border-gray-300"
        >
          <Ionicons size={32} name="close" color="#F2223A" />
        </TouchableOpacity>
        ...
        <TouchableOpacity className="p-3 bg-white rounded-full border-[0.5px] border-gray-300">
          <Ionicons size={25} name="person-add-outline" color="#2983DC" />
        </TouchableOpacity>
