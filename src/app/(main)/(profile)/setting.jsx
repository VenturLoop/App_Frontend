        ...
        <View className="flex-1 px-4 gap-8 bg-white  items-center w-full ">
          <View className="flex-1 gap-6 pb-6   ">
            ...
            <View className="w-full gap-3">
              ...
              <View className="gap-5 border-y-[0.5px] border-gray-300 py-4 ">
                ...
                <Text className="text-sm text-gray-400">
                  ...
                  discovered to new people.You can still chat with your current
                  connections
                </Text>
              </View>
            </View>
            ...
            <View className="gap-3  ">
              <Text className="text-gray-400 font-semibold ">Subscription</Text>
              <View className="gap-3 ">
                {/* Choose sector */}
            ...
            <View className="gap-3  ">
              <Text className="text-gray-400 font-semibold ">Notification</Text>
              <View className="gap-3 ">
                {/* Choose sector */}
